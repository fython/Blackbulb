...
public class RadialTextsView extends View {
    ...
    public void initialize(Context context, String[] texts, String[] innerTexts,
        ...
        mPaint.setColor(context.getResources().getColor(textColorRes));
        ...
        int selectedTextColor = context.getResources().getColor(R.color.mdtp_white);
        ...
        mInactivePaint.setColor(context.getResources().getColor(inactiveColorRes));
