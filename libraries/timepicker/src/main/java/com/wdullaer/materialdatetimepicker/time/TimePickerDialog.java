...
public class TimePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedColor = context.getResources().getColor(R.color.mdtp_white);
        mUnselectedColor = context.getResources().getColor(R.color.mdtp_accent_color_focused);
        ...
        int circleBackground = context.getResources().getColor(R.color.mdtp_circle_background);
        int backgroundColor = context.getResources().getColor(R.color.mdtp_background_color);
        int darkBackgroundColor = context.getResources().getColor(R.color.mdtp_light_gray);
        int lightGray = context.getResources().getColor(R.color.mdtp_light_gray);
    ...
    public boolean isOutOfRange(Timepoint current) {
		return mMinTime != null && mMinTime.compareTo(current) > 0 ||
				mMaxTime != null && mMaxTime.compareTo(current) < 0 ||
				mSelectableTimes != null && !Arrays.asList(mSelectableTimes).contains(current);
